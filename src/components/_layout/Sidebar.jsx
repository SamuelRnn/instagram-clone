...
function Sidebar({ user }) {
	...
	return (
		<div className="bg-main-black-accent border-r border-zinc-800 fixed md:sticky top-0 h-screen overflow-y-auto w-[270px] shadow-md  max-md:translate-x-[-270px]">
			<nav className="h-full flex flex-col justify-between gap-5">
				<div>
					<Image
						src={white_text_logo}
